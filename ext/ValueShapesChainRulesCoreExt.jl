...
using ValueShapes
using ValueShapes: _adignore_call, _data, _valshape, _accessors, _AnySNTArray,
    ConstAccessor, view_idxs
...
function _shapedasntarray_tangent(
    ...
    ArrayOfSimilarArrays(unshaped.(_backing.(dY), Ref(gradient_shape(vs))))
end
